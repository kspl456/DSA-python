...
# Your task is to fill the bag with exactly W kgs of gold such that the total value
# of the gold inside the bag is maximum.
...
# i.e. for the first sample 2.5 kg has value 2.5 and for the second sample 2.5 kg has value 5,
# hence the total value of the bag becomes 7.5
